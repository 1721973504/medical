...
<script type="text/javascript">
  ...
  var setting = {
		...
		async: {
			 ...
			 otherParam: ["treeID", "0","roleid","<%=roleid%>"]
		}
  ...
  <div class="body-content">
    <form id="form-addrole" method="post" class="form-x" action="<%=path%>/system/RoleServlet?m=edit">  
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<%=model.getRoleid() %>" readonly="readonly" name="roleid" data-validate="required:请输入角色编号" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<%=model.getRoleName() %>" name="rolename" data-validate="required:请输入角色编号" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <button id="addRole_btn" class="button bg-main icon-check-square-o" type="button"> 提交</button>
        </div>
      </div>
    </form>
  </div>
