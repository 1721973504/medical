...
<%
	...
	Object[]params={};
	List<Role> roleList=dao.queryOjects(sql, params);
	//加载用户原有信息
		...
		<div class="body-content">
			<form id="form-add" method="post" class="form-x"
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" readonly="readonly" class="input w50" value="<%=model.getUserid() %>" name="userid"
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="<%=model.getFullname() %>" name="fullname"
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="<%=model.getPwd() %>" name="pwd" id="pwd"
